...
**Your Assigned Files:** Read from `_dd_inventory.json` under `domains.natural-gas.files[]`
**Output Path:** `${WORKSPACE_FOLDER}/research/natural-gas-report.md`

1. Read `${WORKSPACE_FOLDER}/_dd_inventory.json`
2. Extract the file list from `domains.natural-gas.files[]`
...
6. Write your report to `${WORKSPACE_FOLDER}/research/natural-gas-report.md`
...
2. Extract the file list from `domains.natural-gas.files[]` and read each file directly using the Read tool
