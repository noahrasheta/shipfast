...
**Your Assigned Files:** Read from `_dd_inventory.json` under `domains.connectivity.files[]`
**Output Path:** `${WORKSPACE_FOLDER}/research/connectivity-report.md`

1. Read `${WORKSPACE_FOLDER}/_dd_inventory.json`
2. Extract the file list from `domains.connectivity.files[]`
...
6. Write your report to `${WORKSPACE_FOLDER}/research/connectivity-report.md`
...
2. Extract the file list from `domains.connectivity.files[]` and read each file directly using the Read tool
