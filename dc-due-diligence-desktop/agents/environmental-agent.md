...
**Your Assigned Files:** Read from `_dd_inventory.json` under `domains.environmental.files[]`
**Output Path:** `${WORKSPACE_FOLDER}/research/environmental-report.md`

1. Read `${WORKSPACE_FOLDER}/_dd_inventory.json`
2. Extract the file list from `domains.environmental.files[]`
...
6. Write your report to `${WORKSPACE_FOLDER}/research/environmental-report.md`
...
2. Extract the file list from `domains.environmental.files[]` and read each file directly using the Read tool
