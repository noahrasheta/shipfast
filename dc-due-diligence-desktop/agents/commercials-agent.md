...
**Your Assigned Files:** Read from `_dd_inventory.json` under `domains.commercials.files[]`
**Output Path:** `${WORKSPACE_FOLDER}/research/commercials-report.md`

1. Read `${WORKSPACE_FOLDER}/_dd_inventory.json`
2. Extract the file list from `domains.commercials.files[]`
...
6. Write your report to `${WORKSPACE_FOLDER}/research/commercials-report.md`
...
2. Extract the file list from `domains.commercials.files[]` and read each file directly using the Read tool
