...
**Your Assigned Files:** Read from `_dd_inventory.json` under `domains.land-zoning.files[]`
**Output Path:** `${WORKSPACE_FOLDER}/research/land-zoning-report.md`

1. Read `${WORKSPACE_FOLDER}/_dd_inventory.json`
2. Extract the file list from `domains.land-zoning.files[]`
...
6. Write your report to `${WORKSPACE_FOLDER}/research/land-zoning-report.md`
...
2. Extract the file list from `domains.land-zoning.files[]` and read each file directly using the Read tool
